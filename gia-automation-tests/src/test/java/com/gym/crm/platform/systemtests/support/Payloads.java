...
import static com.gym.crm.platform.systemtests.support.PayloadField.ACTION_TYPE;
import static com.gym.crm.platform.systemtests.support.PayloadField.ADDRESS;
import static com.gym.crm.platform.systemtests.support.PayloadField.DATE_OF_BIRTH;
import static com.gym.crm.platform.systemtests.support.PayloadField.FIRST_NAME;
import static com.gym.crm.platform.systemtests.support.PayloadField.IS_ACTIVE;
import static com.gym.crm.platform.systemtests.support.PayloadField.LAST_NAME;
import static com.gym.crm.platform.systemtests.support.PayloadField.PASSWORD;
import static com.gym.crm.platform.systemtests.support.PayloadField.SPECIALIZATION;
import static com.gym.crm.platform.systemtests.support.PayloadField.TRAINEE_USERNAME;
import static com.gym.crm.platform.systemtests.support.PayloadField.TRAINER_FIRST_NAME;
import static com.gym.crm.platform.systemtests.support.PayloadField.TRAINER_LAST_NAME;
import static com.gym.crm.platform.systemtests.support.PayloadField.TRAINER_USERNAME;
import static com.gym.crm.platform.systemtests.support.PayloadField.TRAINING_DATE;
import static com.gym.crm.platform.systemtests.support.PayloadField.TRAINING_DURATION;
import static com.gym.crm.platform.systemtests.support.PayloadField.TRAINING_NAME;
import static com.gym.crm.platform.systemtests.support.PayloadField.USERNAME;
...
public final class Payloads {
    ...
    public static Map<String, Object> createTrainingPayload(String traineeUsername, String trainerUsername, int duration) {
        return Map.of(TRAINEE_USERNAME.getValue(), traineeUsername,
                      ...
                      TRAINING_DATE.getValue(), LocalDate.now().toString(),
